...
with st.sidebar:
    ...
    # Added to prevent error when no company is selected
...
if len(selected_company_names) == 0:
    ...
    fig_stock1 = px.line(filtered_data, x='date', y='wealth_index', color='symbol', markers=True)
    fig_stock1.update_layout(xaxis_title='Date (YYYY/MM/DD)', yaxis_title='Wealth Index')
