...
def clean_company_overview(dataframe_argx: pd.DataFrame, dataframe_gmab: pd.DataFrame ) -> pd.DataFrame:
    ...
    transformed_df = rename_columns(transformed_df, ['symbol', 'asset_type','name', 'description', 'exchange', 'currency', 'sector', 'industry','web_site','market_cap', 'dividend_per_share', 'dividend_yield', 'revenue_per_share', 'profit_margin', '52_week_high', '52_week_low', '50_day_moving_average'])
    transformed_df = add_primary_id(transformed_df, 'company_id')
    transformed_df = reorder_columns(transformed_df, ['company_id', 'symbol', 'asset_type', 'name', 'description', 'exchange', 'currency', 'sector', 'industry','web_site','market_cap', 'dividend_per_share', 'dividend_yield', 'revenue_per_share', 'profit_margin', '52_week_high', '52_week_low', '50_day_moving_average'])
